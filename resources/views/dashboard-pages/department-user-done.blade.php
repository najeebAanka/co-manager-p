...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card mt-5">
                <div class="card-header">{{ __('general.tasks-done') }}</div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <?php $todos = \App\Models\TodoJob::where('assigned_to', Route::input('user_id'))->where('current_status' ,'done')->orderBy('id' ,'desc')->paginate(10);
