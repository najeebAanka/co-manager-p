...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card mt-5">
                <div class="card-header">{{ __('general.evaluations') }}</div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        // $users = \App\Models\User::join('model_has_roles', 'users.id', 'model_has_roles.model_id')->where('model_has_roles.role_id', '!=', 1)->orderBy('id' ,'desc')->paginate(10);
                        
                        $users = \App\Models\User::where('department_id', '!=', -1)->orderBy('id' ,'desc')->paginate(10);
 foreach ($users as $u){
                        ?>
